(function() {
    ...
    if (!document.getElementById('renamer-pdf-styles')) {
        ...
        ps.textContent = [
            ...
            '#pdf-ctx-menu button.pdf-ctx-active{background:rgba(124,58,237,0.3)}',
            ...
            '.pdf-loader-content{background:var(--lib-settings-btn-bg);border-radius:var(--nc-radius);padding:24px 32px;min-width:320px;max-width:480px;display:flex;flex-direction:column;align-items:center;gap:14px;box-shadow:0 8px 32px rgba(0,0,0,0.3);color:var(--nc-text)}',
            '.pdf-loader-content .pdf-loader-spinner{width:48px;height:48px;border:4px solid rgba(124,58,237,0.2);border-top-color:var(--nc-blue);border-radius:50%;animation:pdf-spin 0.9s linear infinite}',
            ...
            '.pdf-rule-number-2{background:var(--reader-accent)}',
